...
class MenuIcons {
  // 实时监控
  static const IconData monitoring = IconData(0xe615, fontFamily: 'myIcons');
  ...
  // 拼团商城
  static const IconData assemble = IconData(0xe635, fontFamily: 'myIcons');

  // 每日签到
  static const IconData signIn = IconData(0xe755, fontFamily: 'myIcons');

  // 积分商城
  static const IconData integralShop = IconData(0xe64e, fontFamily: 'myIcons');

  // 热点新闻
  static const IconData hotNews = IconData(0xe697, fontFamily: 'myIcons');
